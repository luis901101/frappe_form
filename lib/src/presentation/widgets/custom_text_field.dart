...
class CustomTextField extends StatefulWidget {
  ...
  final CustomButtonDefaultAction customButtonDefaultAction;
...
//      filled: true,
        ...
        customButton = customButton ?? CustomButton.onText,
        customButtonDefaultAction =
            customButtonDefaultAction ?? CustomButtonDefaultAction.clear;

  @override
  State createState() => CustomTextFieldState<CustomTextField>();
}
...
class CustomTextFieldState<S extends CustomTextField> extends State<S> {
  ...
  void initState() {
    ...
    controller.textFieldState = this;
    lastText = controller.text;
    if (widget.customButtonDefaultAction ==
  ...
  bool get showCustomButton {
    switch (widget.customButton) {
      case CustomButton.onText:
        return hasText;
      case CustomButton.always:
        return true;
      case CustomButton.none:
        return false;
    }
  }
